          ...
          <div class="box">
            <div class="title help-course-f">
              <ul class="nav nav-tabs" style="margin-top: 16px;padding-left: 16px;">
                <li class="active"><a href="<?php echo url('category/attr');?>">分类属性</a></li>
              </ul>
                ...
                <li class="previous">
                  <div class="form-inline text-right marginTop">
                    ...
                    <div class="form-group" style="position:relative;">
                      <input class="form-control changeStyle ui-input" type="text" name="keyword" placeholder="请输入属性名称" value="<?php echo $keyword;?>">
              ...
              <table class="table table-bordered" id="template">
                ...
                <tbody>
                  ...
                  <tr style="height: 55px;">
                    ...
                    <td><?php foreach($catlists as $k => $d)  if($v['cid']==$k){echo $d;}?></td>
