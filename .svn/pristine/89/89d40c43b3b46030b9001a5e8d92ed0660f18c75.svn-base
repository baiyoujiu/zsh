...
<div class="user_right_box2017">
  <div class="account_recharge_box" style="clear:both;">
    <div class="account_recharge_tabhref">
      <ul>
        <li><a href="<?php echo url('pzu/mrecharge');?>" title="充值管理" class="active">充值管理</a></li>
        <li><a href="<?php echo url('pzu/mwithdraw');?>" title="提现管理">提现管理</a></li>
      </ul>
    </div>
          ...
          <table width="100%">
            ...
            <tbody>
              ...
              <tr class="recharge_tab_hrefotr">
                ...
                <th><?php echo ($val['status'] == '1')?'<a href="javascript:void(0);" class="colorred audit" data-s="2" data-no="'.$val['recharge_no'].'">成功</a>　　<a href="javascript:void(0);" class="colorred audit" data-s="3" data-no="'.$val['recharge_no'].'">失败</a>':$financeStatusArr[$val['status']];?></th>
              </tr>
              <?php }} ?>
            </tbody>
            <tfoot>
...
$(function () {
	$('.audit').click(function(){
		...
		$.ajax( {
			url :'<?php echo url('pzu/mchargesave'); ?>' ,
