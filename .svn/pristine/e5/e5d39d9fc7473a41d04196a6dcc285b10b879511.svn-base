				...
				<div class="action">
                    ...
                    <ul class="zhuce_users_lists">
						<li class="clearfix zhuce_iphone">
							...
							<input class="fl zhuce_iphone_int inp" name="phone" type="text" maxlength="12"/>
                        ...
                        <li class="clearfix zhuce_yanzhengma">
							...
							<input class="fl zhuce_yanzhengma_int inp" name="students" type="text" maxlength="10"/>
							<img class="fr zhuce_Group" src="__IMG__/zhuce_Group.png">
						</li>
					</ul>
