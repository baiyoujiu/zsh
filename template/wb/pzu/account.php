...
<div class="user_right_box2017">
  <div class="account_box hengruibao_in_box">
    <div class="tab_link_style"> <span class="row_jl">收支明细</span>
        <ul id="record"><li>&nbsp;</li><li>&nbsp;</li><li>&nbsp;</li><li><span class="colorred" style="width: 230px;">账户余额：<strong><?php echo number_format($finfo['balance']/100,2);?></strong>元</span></li></ul>
    </div>
    <div class="user-box-2">
      ...
      <form action="" method="get">
          ...
          　业务编号:<input name="keywords" type="text" class="input-text-style-1" value="<?php echo $keywords;?>" placeholder="请输入业务编号" />
