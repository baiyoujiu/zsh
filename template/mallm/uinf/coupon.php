...
<section class="yhq_ym_box">
  <ol class="yhq_lists clearfix">
    <li class="fl active"> <i>未使用</i> </li>
    <li class="fl"> <i>已使用</i> </li>
    <li class="fl"> <i>已过期</i> </li>
  </ol>
  <!--未使用-->
    ...
    <ul class="yhq_wsy_list">
      ...
      <li>
        <div class="clearfix">
          ...
          <span class="up_qiu"></span> <span class="center_xian"></span> <span class="down_qiu"></span>
          <div class="fl yhq_wsy_right">
            <h3><?php echo $v['name'];?></h3>
            <h2><?php echo $v['rules'];?></h2>
          </div>
        </div>
        <div class="yhq_wsy_xq"> <span></span>
