{include file="common/header" /}
	<script>
		...
		<section class="dingdan_nav_list">
			...
			foreach($lists as $v){
				$amun++;
				////状态:1-下单|2-卖家已确认待发|3-已发货待收货|5-买家确认收货|6-系统收货|8-卖家取消订单|9-系统关闭未付款订单
				switch ($v['status']) {
					case 1:
						if($v['pay_status'] == 1){
							$unpay++;
			...
			<nav style="display:block;">
				<ul class="qbdd_lists">
                	<?php if($amun<1){echo '<section class="dingdan_kong"><div>暂无订单！</div></section>';}?>
                    ...
                    <li>
						...
						<div class="qbdd_lists_word2 clearfix">
							<p class="fr"><i>共<?php echo $v['goodnum']?>件</i><i>合计：<em>￥<?php echo number_format($v['amount']/100,2);?></em></i></p>
						</div>
                        </a>
						<div class="clearfix qbdd_lists_btns">
                            ...
                            <a href="#"><span class="fr back_yellow">收货</span></a>
                            <?php }?>
			...
			<nav>
				<ul class="qbdd_lists">
					<?php if($unpay<1){echo '<section class="dingdan_kong"><div>暂无订单！</div></section>';}?>
			...
			<nav>
				<ul class="qbdd_lists">
					<?php if($unsend<1){echo '<section class="dingdan_kong"><div>暂无订单！</div></section>';}?>
			...
			<nav>
				<ul class="qbdd_lists">
					<?php if($unsh<1){echo '<section class="dingdan_kong"><div>暂无订单！</div></section>';}?>
			...
			<nav>
				<ul class="qbdd_lists">
					<?php if($end<1){echo '<section class="dingdan_kong"><div>暂无订单！</div></section>';}?>
